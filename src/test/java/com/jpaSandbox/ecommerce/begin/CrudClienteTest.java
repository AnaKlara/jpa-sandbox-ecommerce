package com.jpaSandbox.ecommerce.begin;
...
//        cliente.setId(3);  Estamos usando @GeneratedValue(strategy = GenerationType.IDENTITY)
...
//        cliente.setId(1); Estamos usando @GeneratedValue(strategy = GenerationType.IDENTITY)
